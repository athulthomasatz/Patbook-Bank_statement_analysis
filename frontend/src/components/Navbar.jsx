    ...
    >
              ...
              return (
                <Link
                  ...
                  className={`relative px-4 py-2 text-sm font-medium transition-colors ${
                    isActive ? "text-[var(--primary-accent)]" : "text-[var(--text-muted)] hover:text-[var(--text-main)] hover:bg-[var(--text-muted)]/10 rounded-full"
                  }`}
                >
                  {item.label}
                  {isActive && (
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <div className="relative w-5 h-5 flex items-center justify-center pointer-events-none">
                ...
                <div 
                  className={`absolute transition-all duration-500 cubic-bezier(0.4, 0, 0.2, 1) ${
                    theme === "dark" 
      ...
      <div
        className={`md:hidden overflow-hidden transition-all duration-300 ease-in-out ${
          mobileMenuOpen ? "max-h-64 border-b border-[var(--border-color)] bg-[var(--card-bg)]/95 backdrop-blur-md" : "max-h-0"
        }`}
      >
